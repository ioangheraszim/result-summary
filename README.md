...
- **Bonus**: Use the local JSON data to dynamically populate the content ✔️
...
- Solution URL: [Solution URL here](https://github.com/ioangheraszim/result-summary)
- Live Site URL: [Live site URL here](https://ioangheraszim.github.io/result-summary/)
